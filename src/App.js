...
const PACKS = {
  standard: {
    ...
    choices: {
      ...
      windows: {
        label: "Окна (профиль)",
        options: { "РЕХАУ CONSTANTA": 0, "РЕХАУ GRAZIO 70мм": 30_000 },
      },
      glazing: {
        label: "Стеклопакет",
        options: { "Двухкамерный 32мм": 0, "Энергосберегающий 40мм": 55_000 },
      },
      ventilation: {
  ...
  optima: {
    ...
    choices: {
      ...
      foundation: {
        label: "Фундамент",
        options: { "Ж/Б сваи 3 м": 0, "Винтовые сваи 2,5 м × 108 мм": -45_000 },
      },
      windows: {
        label: "Окна (профиль)",
        options: { "РЕХАУ GRAZIO 70мм": 0, "РЕХАУ CONSTANTA": -30_000 },
      },
      glazing: {
        label: "Стеклопакет",
        options: { "Двухкамерный 32мм": 0, "Энергосберегающий 40мм": 55_000 },
      ...
      ventilation: {
        label: "Вентиляция утеплённая",
        options: { "0": 0, "1 шт.": 35_000, "2 шт.": 70_000 },
      },
      color: {
        label: "Цвет фасада/крыши",
        options: {
          "Серый графит RAL 7024": 0,
          "Коричневый шоколад RAL 8017": 0,
          "Красное вино RAL 3005": 0,
        },
      },
    },
  },
...
export default function UyutLanding() {
  ...
  <div className="min-h-screen bg-neutral-50 наtext-neutral-900" style={{ paddingTop: promoOffset + 68 }}>
        ...
        <div className="fixed right-4 bottom-20 z-40 md:hidden flex flex-col gap-2">
          {/* WhatsApp */}
          <a
            href={`https://wa.me/${CONTACTS.phoneWhatsapp.replace(/[^\d]/g, '')}?text=Здравствуйте! Интересует строительство дома «Уют-71ФИКС».`}
            target="_blank"
            rel="noopener noreferrer"
